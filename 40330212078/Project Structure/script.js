...
//farakhne ta resedan be halat paye
...
//exhanoi 5 be tanhaye dorost nmishod baraye hamin tabe komake estefade shod

//farakhne ta resedan be halat paye
function komak_exhanoi_5(A, B, C, D,  n) {
    if(n==1){
        moves.push([A,D]);
        moves.push([D,C]);
    }
    else{
        komak_exhanoi_5(A , B , C , D , n-1);
        moves.push([A,B]);
        komak_exhanoi_5(C , D , A , B , n-1);
        moves.push([B,C]);
        komak_exhanoi_5(A , B , C , D , n-1);
    }
}

//farakhne payapey hamrah ba hanio komaki ta resedan be halat paye
...
function exhanoi_5(A, B, C, D, n) {
    if(n==1){
        ...
        moves.push([B,A]); 
        moves.push([C,B]); 
        moves.push([C,D]); moves.push([B,C]); moves.push([C,D]);
        moves.push([A,B]); moves.push([B,C]); moves.push([C,D]); 
        moves.push([A,B]); moves.push([B,C]); moves.push([B,A]);
        moves.push([B,C]); moves.push([A,B]); moves.push([B,C]); 
        moves.push([D,A]); moves.push([A,B]); moves.push([D,A]);
        moves.push([D,C]); moves.push([A,D]); moves.push([D,C]); 
        moves.push([B,C]);
    }
    else{
        exhanoi_5(A , B , C , D , n-1);
        moves.push([A,D]);
        komak_exhanoi_5(C , D , A , B , 6*n-3);
        moves.push([D,C]);
        moves.push([B,C]);
        moves.push([C,D]);
        moves.push([B,C]);
        moves.push([D,C]);
        komak_exhanoi_5(A , B , C , D , 6*n-3);
    }
    return
}
